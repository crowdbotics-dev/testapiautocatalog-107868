...
## Project Structure
    ...
    ├── testapiautocatalog_107868  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_107868`
...
2. Clone this repo and `cd testapiautocatalog_107868`
